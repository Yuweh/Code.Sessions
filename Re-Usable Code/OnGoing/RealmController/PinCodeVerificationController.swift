...
class PinCodeVerificationController: SettingsRootViewController, UITextFieldDelegate{
    ...
    //Realm Q.Variables: Called @ViewDidLoad
        ...
        didSet{
            ...
            if self.pinCodeInput.length == 6{
                ...
                if pinUserProfile.pinNumber == nil {
                    ...
                    self.existingPinUserValidator(enteredPinCode: input_textField.text!)
                }
...
//        SettingsWireframe(navController).navigate(to: .AccessSettingsMainView)
        ...
        let messages = NSAttributedString(string: "Thank you for using GBA Mobile Banking Application. Your New PIN Code has now been saved", attributes: [NSAttributedStringKey.font: UIFont(name: "Helvetica Neue", size: GBAText.Size.subContent.rawValue)!])
